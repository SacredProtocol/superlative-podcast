export const siteConfig = {
  ...
  episodes: [
    ...
    {
      title: "Episode 37",
      episodeTitle: "An insider view into investing in the Middle East",
    ...
    {
      title: "Episode 36",
      episodeTitle: "The AI Bubble Is a Financing Phase",
      guest: "Shane Wilson",
    ...
    {
      title: "Episode 35",
      episodeTitle: "Customer Acquisition Is War",
      guest: "Mike Ma",
    ...
    {
      title: "Episode 34",
      episodeTitle: "Where engineering agriculture breaks down.",
      guest: "Peter Herz",
    ...
    {
      title: "Episode 33",
      episodeTitle: "AI Boundaries are not Brakes",
      guest: "Ronald Bazar",
      guestTitle: "Founder",
    ...
    {
      title: "Episode 32",
      episodeTitle: "India's Deep Tech Flywheel Just Started",
